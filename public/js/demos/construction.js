...
function one() {
    ...
    $("#image-title").text("Site Management");
...
function two() {
    ...
    $("#image-title").text("Store Management");
...
function three() {
    ...
    $("#image-title").text("Purchase Order & Reconciliation");
...
function four() {
    ...
    $("#image-title").text("Inventory Tracking");
...
function five() {
    ...
    $("#image-title").text("Inventory Usage & Site Progress");
...
function six() {
    ...
    $("#image-title").text("Vendor/Supplier Management");
...
function seven() {
    ...
    $("#image-title").text("Sub Contractor Management");
